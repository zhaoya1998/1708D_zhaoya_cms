	...
	<div class="container" style="margin-top: 5px">
		<div class="row">
			...
			<div class="col-md-2" style="height: 550px" >
				...
				<ul class="list-group"  class="form-inline">
					<li class="channel-item ${article.channelId==null?"active":"" }" ><a
						href="/" style="color: black">推荐</a></li>

					<c:forEach items="${channels}" var="c">

						<li class="channel-item ${c.id==article.channelId?"active":"" }" ><a
							href="?channelId=${c.id }" style="color: black">${c.name } </a></li>
							...
							<div class="carousel-inner">
								...
								<c:forEach items="${slides}" var="s" varStatus="i">
									<div class="carousel-item ${i.index==0?"active":"" }" >
										<img src="/cms/pic/${s.url }" class="d-block w-100" alt="..." style="height: 300px;width: 200px">
				...
				<div>
					<ul class="subchannel">
						<li class="sub-item ${article.categoryId==null?"sub-selected":"" }"><a
							class="nav-link" href="?channelId=${article.channelId}" style="color: black">全部 </a></li>
						<c:forEach items="${categorys}" var="c">
							<li class="sub-item ${c.id==article.categoryId?"sub-selected":"" }" ><a
								class="nav-link"
								href="?channelId=${article.channelId}&categoryId=${c.id }" style="color: black">${c.name }
							</a></li>
						</c:forEach>
					</ul>
					...
					<c:forEach items="${info.list}" var="a">
						<div class="media">
							<a href="/article?id=${a.id}" target="_blank"><img
								src="/cms/pic/${a.picture }" class="mr-3" alt="..."
						...
						<div class="class-body">
							<div class="media">
								<a href="/article?id=${last.id}" target="_blank"><img
									src="/cms/pic/${last.picture }" class="mr-3" alt="..."
